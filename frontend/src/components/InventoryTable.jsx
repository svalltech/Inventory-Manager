...
const InventoryTable = ({ data, entriesPerPage, currentPage, setCurrentPage, onEdit, onDelete }) => {
  ...
  // Sortable columns
  const sortableColumns = ['category', 'name', 'sku', 'brand', 'warehouse', 'product_type', 'design', 'size', 'quantity', 'selling_price', 'totalValue'];
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tfoot className="bg-slate-100 border-t-2 border-slate-300">
            ...
            <tr>
              <td colSpan="11" className="px-6 py-3 text-sm text-slate-600 bg-slate-50">
