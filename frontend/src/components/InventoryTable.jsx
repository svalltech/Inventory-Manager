...
const InventoryTable = ({ data, entriesPerPage, currentPage, setCurrentPage, onEdit, onDelete, onQuickAdd }) => {
                    ...
                    >
                          ...
                          {group.color && (
                            <div className="relative group/color">
                              <div 
                                ...
                                style={{ backgroundColor: getColorCode(group.color) }}
                              />
                      ...
                      <td className="px-3 py-3 text-sm">
                        <div className="flex items-center">
                          ...
                          {hasLowStock && (
                            <svg className="w-4 h-4 text-orange-600 ml-1 animate-pulse" fill="currentColor" viewBox="0 0 20 20" title="Low stock alert!">
                      ...
                      >
                        ...
                        <td className="px-3 py-3 text-sm">
                          <div className="flex items-center">
                            ...
                            {isLowStock && (
                              <svg className="w-4 h-4 text-orange-600 ml-1 animate-pulse" fill="currentColor" viewBox="0 0 20 20" title={`Low stock! (Below ${item.low_stock_threshold || 10})`}>
                                <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                              </svg>
                            )}
                            <div className="relative group/tooltip ml-1">
                        ...
                        <td className="px-3 py-3">
                          <div className="flex space-x-1">
                            <button
                              ...
                              className="p-1.5 text-green-600 bg-green-50 hover:bg-yellow-50 rounded-lg transition"
                            >
                              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
